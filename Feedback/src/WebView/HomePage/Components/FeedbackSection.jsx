...
import email from "../../Sign Up Page/Components/email.png";
import mobile from "../../Sign Up Page/Components/mobile.png";
import password from "../../Sign Up Page/Components/password.png";
import user from "../../Sign Up Page/Components/user.png";
...
export default function FeedbackSection() {
  ...
  useEffect(() => {
    ...
    notify("Give us a few seconds while we fetch the products from our servers.")
  }, []);
    ...
    <div className="FeedbackSection">
      ...
      >
        <div className="formModal">
          {displayForm(isLoggedIn, setIsLoggedIn, signUp, setSignUp, notify, formDataLI, setFormDataLI)}
        </div>
...
function displayForm(isLoggedIn, setIsLoggedIn, isSignUp, setSignUp, notify, formDataLI, setFormDataLI) {
  if (isLoggedIn == false) {
    if (isSignUp)
      return (
        <div className="signUpForm">
          <p>Signup to Continue</p>
          <form action="https://feedback-d89u.onrender.com/register" method="post"
          onChange={(e)=>setFormDataLI({...formDataLI, [e.target.name]:e.target.value})}
    ...
    return (
      <div className="signUpForm">
        ...
        <form action="https://feedback-d89u.onrender.com/login" method="post"
        onChange={(e)=>setFormDataLI({...formDataLI, [e.target.name]:e.target.value})}
  ...
  return(
    <div className="signUpForm">
      ...
      <form action="" method="post" className="addProducts"
      onChange={(e)=>setFormDataLI({...formDataLI, [e.target.name]:e.target.value})}
      onSubmit={(e)=>handleAddProduct(e, formDataLI, notify)}>
          <input type="text" name="companyName" id="companyName" placeholder="Name of the company."/>
          <input type="text" name="category" id="category" placeholder="Category" />
          <input type="text" name="logoURL" id="logoURL" placeholder="Add logo URL" />
          <input type="text" name="productLink" id="productLink" placeholder="Link of Product" />
          <input type="text" name="productDescrip" id="productDescrip" placeholder="Add description" />
          <button type="submit">
            + Add
          </button>
      </form>
